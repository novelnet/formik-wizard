        ...
        var _temp7 = _catch(
          function () {
            function _temp3() {
              ...
              return _step$onAction2
                ? Promise.resolve(
                    step.onAction(sectionValues, values, wizard)
                  ).then(_temp)
                : _temp(undefined) // if (info.isLastStep) {
